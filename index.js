...
function gera_jogador(idade) {
    ...
    let mensagem_jogador = `${dados.nome[ger_nome]} ${dados.sobrenome[ger_sob]} é um futebolista brasileiro ${texto} que atua como ${dados.posicao[ger_pos]}. Atualmente defende o ${dados.clube[ger_clube]}.`;
